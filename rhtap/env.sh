...
export IMAGE_URL=${IMAGE_URL-quay.io/rhtap_qe/go-rkuexlob:$CI_TYPE-$TAG}
...
export ROX_CENTRAL_ENDPOINT="central-tssc-acs.apps.rosa.kx-dbf5746b4b.w2rb.p3.openshiftapps.com:443"
...
export GITOPS_REPO_URL=https://github.com/rhtap-rhdh-qe/go-rkuexlob-gitops
...
export COSIGN_PUBLIC_KEY="LS0tLS1CRUdJTiBQVUJMSUMgS0VZLS0tLS0KTUZrd0V3WUhLb1pJemowQ0FRWUlLb1pJemowREFRY0RRZ0FFaHU4UFc1T1d5eUFWcHRHOFMvZDdMOFJRQUhiYgp2V0MyNTlqc3dRQ25CYUZZdDU2cGdwMHdWSG1ydStqcnkyNzZpSlNLUkNnOTlPSHBiRjA4VHlaelZnPT0KLS0tLS1FTkQgUFVCTElDIEtFWS0tLS0tCg=="
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-tssc-tas.apps.rosa.kx-dbf5746b4b.w2rb.p3.openshiftapps.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-tssc-tas.apps.rosa.kx-dbf5746b4b.w2rb.p3.openshiftapps.com}
